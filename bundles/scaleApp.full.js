...
(function() {
  ...
  StateMachine = (function() {
    ...
    function StateMachine(opts) {
      ...
      this.actions = new scaleApp.Mediator;
      this.states = [];
      this.transitions = {};
      if (opts.start != null) {
    ...
    StateMachine.prototype.addState = function(id, opt) {
      ...
      if (id instanceof Array) {
        ...
        success = [];
        if (opt.enter != null) {
          success.push(this.actions.on("" + id + "/enter", opt.enter));
        }
        if (opt.leave != null) {
          success.push(this.actions.on("" + id + "/leave", opt.leave));
        }
    ...
    StateMachine.prototype.onEnter = function(state, cb) {
      return this.actions.on("" + state + "/enter", cb);
    };
