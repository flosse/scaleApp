...
window.scaleApp);(function(i,c){c.sandbox=c.sandbox||function(e){function f(a){return c.template.get(e,a)}function d(a,b,d){c.publish(a,b,d)}var b={h:function(a){c.log.debug(a,e)},info:function(a){c.log.info(a,e)},warn:function(a){c.log.warn(a,e)},error:function(a){c.log.error(a,e)},i:function(a){c.log.fatal(a,e)}};return{subscribe:function(a,b){c.subscribe(e,a,b)},unsubscribe:function(a){c.unsubscribe(e,a)},publish:d,startSubModule:function(a,b,d,f){c.startSubModule(a,b,d,e,f)},stopSubModule:function(a){c.stop(a)},
getModel:function(a){return c.a.getModel(e,a)},getView:function(a){return c.a.getView(e,a)},getController:function(a){return c.a.getController(e,a)},addModel:function(a,b){return c.a.addModel(e,a,b)},addView:function(a,b){return c.a.addView(e,a,b)},addController:function(a,b){return c.a.addController(e,a,b)},observable:c.a.observable,getTemplate:f,tmpl:function(a,c){if(typeof a==="string")return $.tmpl(f(a),c);else if(typeof a==="function")return $.tmpl(a,c);else b.error("type of 'id' is not valid",
"sandbox of "+e)},getContainer:function(){return c.getContainer(e)},debug:b.h,info:b.info,warn:b.warn,error:b.error,fatal:b.i,mixin:c.util.mixin,count:c.util.countObjectKeys,_:function(a){return c.i18n._(e,a)},getLanguage:c.i18n.getLanguage,hotkeys:function(a,b,c,e){typeof b==="string"?(e||(e="keypress"),$(document).bind(e,a,function(){d(b,c)})):typeof b==="function"&&(c||(c="keypress"),$(document).bind(c,a,b))}}}})(window,window.scaleApp);
